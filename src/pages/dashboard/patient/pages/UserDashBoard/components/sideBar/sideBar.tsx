import { appointment, dashboard, logout, messages, settings } from '@/assets/icons'
...
const SideBar: FC<SideBarProps> = ({activeItem, handleClick}) => {
  return <div className={styles.sidebar}>
    <div className={styles.sidebar__container}>
      ...
      <div className={`${styles.sidebar__item} ${activeItem === 'history' ? styles.active : ''}`} onClick={() => handleClick('history')}>
        <div className={styles.sidebar__item__icon}>
          {appointment()}
        </div>
      </div>
