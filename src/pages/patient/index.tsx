...
const patient: Patient = {
  id: "",
  name: "John Doe",
  profilePic: "https://images.pexels.com/photos/2743754/pexels-photo-2743754.jpeg",
      ...
      <div className="flex flex-col w-1/5">
        ...
        <div className="h-auto bg-gray-900 rounded-lg mb-4 p-4">
          <div className="flex flex-row justify-between ">
            <h1 className="text-gray-500 text-sm font-semibold">Appointments</h1>
          ...
          {patient.appointments.length > 0 ? (
                  ...
                  <div key={appointment.id} className="flex flex-col my-2">
                    <div className="flex flex-row px-4 item-center">
                      ...
                      <div className="flex flex-col ml-4">
                        <h1 className="text-white text-sm font-semibold">{appointment.reason}</h1>
            ...
            <>
              <p className="text-gray-400 text-sm font-thin ">No upcoming appointments</p>
              <button className="bg-blue-500 text-white my-2 py-2 px-4 rounded-md" onClick={() => handleOpenModal()}>
                    Schedule
                </button>{showModal && <ScheduleModal close={handleCloseModal} />}
        ...
        <div className="h-auto bg-gray-900 rounded-lg p-4">
          <div className="flex flex-row justify-between py-1">
            <h1 className="text-gray-500 text-sm font-semibold">Current Pescription</h1>
            <h1 className="text-accent-green  text-xl font-semibold">...</h1>
          </div>
          {patient.prescription.medicines.map((medicine) => <div key={medicine.name} className="flex flex-col my-2">
            <div className="flex flex-row px-4 item-center">
              <div className="h-2 w-2 bg-accent-green rounded-full place-self-center"></div>
              <div className="flex flex-col ml-4">
                <h1 className="text-white text-sm font-semibold">{medicine.name}</h1>
                <p className="text-gray-400 text-sm font-thin">
                  {medicine.dosage + ' '}
                  - 
                  {' ' + medicine.frequency}
