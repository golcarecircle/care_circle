...
const DashboardLayout: FC<Props> = ({ children, userType }) => {
  return (
    <div className="flex w-full h-screen font-sans bg-gray-800">
      ...
      <main className="flex flex-col flex-1 gap-6 p-4 rounded-lg overflow-hidden">
        <DashboardNav session={null} />
        <div className="overflow-y-auto  scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-800">
          {children}
        </div>
      </main>
    </div>
