    ...
    <footer className={styles.footer}>
      <div className={styles.footer__container}>
        <div className={styles.footer__column}>
          ...
          <p>
            Take control of your health with cutting-edge technology at your
            fingertips
          </p>
        ...
        <div className={styles.footer__column}>
          ...
          <ul>
            ...
            <li>
              <Link href="/product/testimonials">Testimonials</Link>
            </li>
          </ul>
        </div>
        <div className={styles.footer__column}>
        ...
        <div className={styles.footer__column}>
          ...
          <ul>
            ...
            <li>
              <Link href="/support/helpdesk">Help Desk</Link>
            </li>
            <li>
        ...
        <div className={styles.footer__column}>
          ...
          <ul>
            ...
            <li>
              <a href="mailto:info@mycompany.com">
                <FaEnvelope /> info@mycompany.com
              </a>
            </li>
          </ul>
        </div>
